...
Mirrors the `scenario_servers` attachment exactly ([`02`](./02-current-architecture-map.md)), adding
...
[`11-skill-loading-in-real-products.md`](./11-skill-loading-in-real-products.md), which shows every
