# Research — LangSmith observability vs. this app

**Date:** 2026-07-16 · **Status:** decided — the implementation plan + locked decisions
(D-OB1–D-OB28) live at [`roadmap/observability/`](../../roadmap/observability/) (27 WPs,
Phases 1–5, per-WP model map, `/next-wp`-ready), which starts **after**
[`roadmap/unified-sessions/`](../../roadmap/unified-sessions/) (D-US1–15) ships the session
...
This folder is the companion to [`../unified-run-sessions/`](../unified-run-sessions/)
...
- LangSmith facts come from primary sources fetched 2026-07-16 (marketing page, docs at
  ...
  the bottom of [`00-langsmith-feature-inventory.md`](./00-langsmith-feature-inventory.md).
...
| Doc | Contents |
|---|---|
| [`00-langsmith-feature-inventory.md`](./00-langsmith-feature-inventory.md) | What LangSmith observability actually is, feature by feature, with sources |
| [`01-gap-analysis.md`](./01-gap-analysis.md) | Side-by-side against this app across 9 dimensions, with verdicts and a "where we lead" section |
| [`02-enhancement-concept.md`](./02-enhancement-concept.md) | Concept v0: a phased observability workstream (waves O1–O5), backend + frontend, mapped to the existing architecture |
| [`03-open-questions.md`](./03-open-questions.md) | Owner decisions to settle before anything is built (Q-OB1 … Q-OB12) |
