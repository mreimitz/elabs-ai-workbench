...
the [`CLAUDE.md`](../../CLAUDE.md) capability table, the `roadmap/*/STATUS.md` ledgers, and the
[`../langsmith-observability/`](../langsmith-observability/) research (2026-07-16), whose file
...
([`roadmap/observability/`](../../roadmap/observability/), D-OB1–28) and unified sessions
([`roadmap/unified-sessions/`](../../roadmap/unified-sessions/), D-US1–15) were derived from the
