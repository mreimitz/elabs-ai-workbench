...
import { CardDescription, cn } from "@brand/ui";
 ...
 *
 * `@brand/ui`'s `CardDescription` (`vendor card.tsx`) sets no `max-w`, so a description in a
 ...
 *
 * Delete this wrapper when `@brand/ui`'s `CardDescription` caps its own measure by default (or
