...
test("migration v46 — a pre-v46 (v45) DB gains review_rubrics; neighboring rows survive; idempotent", () => {
  ...
  assert.equal(db.pragma("user_version", { simple: true }), 60, "stamped to LATEST (60) after v46");
