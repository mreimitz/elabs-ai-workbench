...
test("migration v40 — a pre-v40 (v39) DB gains the notifications table; idempotent", () => {
  ...
  assert.equal(
    ...
    55,
    "stamped to LATEST (55) after v40+v41+v42+v43+v44+v45+v46",
  );
  ...
  assert.equal(db.pragma("user_version", { simple: true }), 55, "version unchanged after the re-run");
});
