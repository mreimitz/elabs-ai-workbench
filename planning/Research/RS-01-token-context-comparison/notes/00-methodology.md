---
type: "Research Note"
title: "00 \u2014 Comparison Methodology"
description: "How we compare top LLMs for the MCP Token Footprint recommendation engine."
tags: ["research", "RS-01"]
...
> provenance so staleness is visible. See [`README.md`](../topic.md) for how this feeds the product.
...
2. Define the information structure + JSON Schema + template ([`01-information-structure.md`](./01-information-structure.md), [`schema/`](../outputs/schema/)).
...
4. Orchestrator merges into [`comparison/`](../outputs/comparison/) (matrix + combined `all-models.json`).
