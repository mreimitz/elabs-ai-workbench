...
title: "02 \u2014 Concept v0: an observability layer for this app"
description: "Draft for discussion \u2014 not a plan. Shape of the idea, written to be argued with. Owner"
tags: ["research", "RS-04"]
...
> decisions it presupposes are collected in [`03-open-questions.md`](../notes/03-open-questions.md)
> (Q-OB*n*). Wave cuts, names, and defaults are all provisional.

Premise: the gaps in [`01-gap-analysis.md`](../notes/01-gap-analysis.md) are one missing *layer*, not
