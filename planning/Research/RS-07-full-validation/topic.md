...
| --- | --- | --- | --- |
| 02 | [`02-api-review.md`](./notes/02-api-review.md) | `apps/api/src/**` (22 subdirs, ~46k LOC) | 1 C · 11 H · 35 M · 56 L |
| 03 | [`03-web-review.md`](./notes/03-web-review.md) | `apps/web/src/**` (347 files) | 0 C · 3 H · 22 M · 30 L |
| 04 | [`04-shared-contract-infra.md`](./notes/04-shared-contract-infra.md) | `packages/shared`, Docker, CI, e2e, config | 0 C · 2 H · 10 M · 12 L |
| 05 | [`05-dead-code-duplication.md`](./notes/05-dead-code-duplication.md) | jscpd/knip/ts-prune/depcheck + manual verify | 3.36% dup · 2 dead files · ~12 dead exports · 1 dead dep |
| 06 | [`06-security-review.md`](./notes/06-security-review.md) | secrets, zip ingest, injection, SSRF, container | 0 C · 1 H · 4 M · 6 L · 2 I |
| 07 | [`07-docs-consistency.md`](./notes/07-docs-consistency.md) | CLAUDE.md/README/rules/roadmap vs code | 3 H · 5 M · 9 L |
| 08 | [`08-quality-gate.md`](./notes/08-quality-gate.md) | Executed typecheck·test·build·lint | ✅ gate green |
