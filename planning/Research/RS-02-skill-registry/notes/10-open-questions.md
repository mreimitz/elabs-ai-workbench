---
type: "Research Note"
title: "10 \u2014 Decisions log (all resolved)"
description: "Every open question is now answered by the owner (2026-07-01). This is the authoritative decision"
tags: ["research", "RS-02"]
...
- **Block-delete (Q6)** → `DELETE /api/skills/:id/versions/:vid` and skill delete must 409 when a
  ...
  guard hook so the contract is stable). See [`03-data-model.md`](../outputs/03-data-model.md),
  [`05-api-surface.md`](../outputs/05-api-surface.md).
