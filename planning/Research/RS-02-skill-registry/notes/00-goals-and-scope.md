---
type: "Research Note"
title: "00 \u2014 Goals & Scope"
description: "From the brief, verbatim intent \u2192 concrete requirements"
tags: ["research", "RS-02"]
...
- **We do not execute skills.** The app inspects, footprints, and diffs skills. It never runs a
  ...
  app does not execute skill scripts on the host — see [`08`](../outputs/08-scenario-attachment.md).)
