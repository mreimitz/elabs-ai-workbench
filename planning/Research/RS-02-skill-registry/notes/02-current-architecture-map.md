---
type: "Research Note"
title: "02 \u2014 Current architecture map (the template we clone)"
description: "Everything below is the existing MCP-server subsystem, captured with file/line anchors so the"
tags: ["research", "RS-02"]
...
**no new UI dependency required.** (New *API-side* deps are covered in [`06`](../outputs/06-ingestion-and-github.md).)
