...
title: "04 \u2014 Versioning & deep \"what-changed\" diff"
description: "A version is an immutable snapshot (skillversions + its skillfiles). Versions are created,"
tags: ["research", "RS-02"]
...
Priority order (from [`01`](../notes/01-agent-skills-format.md) — `metadata.version` is only a convention):
