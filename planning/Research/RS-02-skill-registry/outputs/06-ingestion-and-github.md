...
title: "06 \u2014 Ingestion pipeline, GitHub import, security"
description: "Lives in apps/api/src/skills/ \u2014 ingest-service.ts (parse/validate/store), git-service.ts"
tags: ["research", "RS-02"]
...
- Validate against the spec ([`01`](../notes/01-agent-skills-format.md)): `name` regex + length + reserved
...
| `yaml` *(maybe)* | robust frontmatter parse | dep-free minimal parser (viable; see [`10`](../notes/10-open-questions.md)) |
