...
title: "01 \u2014 Concept v0: one session contract"
description: "Draft for discussion \u2014 not a plan. This is the current best shape of the idea, written to be"
tags: ["research", "RS-03"]
...
> [`02-open-questions.md`](../notes/02-open-questions.md); several of them could reshape sections below.

Premise: keep the wire format and the persistence model — they already carry everything
(see [`00-current-state.md`](../notes/00-current-state.md) §2). Add a thin normative layer with three
