...
title: "Kickoff prompt \u2014 Claude subscription as a run model (paste into a fresh session)"
description: "Copy everything in the fenced block below into a new session at the repo root"
tags: ["roadmap", "RM-09"]
