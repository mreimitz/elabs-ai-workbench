---
type: "Status Ledger"
title: "Claude subscription as a run model \u2014 work-package status ledger \u00b7 PRIORITY: (owner to set)"
description: "Living state for the claude-subscription plan, read and updated by"
tags: ["roadmap", "RM-09"]
...
> Plan + locked decisions D-CS1–D-CS10 in [`README.md`](./item.md). Reference implementation to
