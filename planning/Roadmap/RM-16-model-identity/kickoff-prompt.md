...
title: "Continuation prompt \u2014 model-identity"
description: "Paste everything below the line into a fresh session started in"
tags: ["roadmap", "RM-16"]
...
[`roadmap/model-identity/README.md`](./item.md) (mission + locked decisions D-MI1–D-MI11) and
...
[`README.md`](./item.md) §1–§2. **Do not re-derive them.**
