...
title: "Assistant Hub \u2014 execution plan (orchestrator + subagents)"
description: "Executed by an orchestrator session driving parallel worktree subagents (the"
tags: ["roadmap", "RM-03"]
...
D-AH1…20 ([README](./item.md)) are fixed input — a WP that thinks a decision is wrong STOPS
