...
title: "Skills plan \u2014 conventions (every WP assumes these)"
description: "Shared rules for all Skills work packages. These mirror the repo rules (CLAUDE.md, .claude/rules/)"
tags: ["roadmap", "RM-24"]
