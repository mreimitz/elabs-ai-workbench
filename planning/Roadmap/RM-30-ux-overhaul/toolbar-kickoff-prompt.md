...
title: "Kickoff prompt \u2014 paste to the PM agent (Opus 4.8) to run the Toolbar-standard program"
description: "You are the Project Manager agent for the Toolbar-standard program of this repo"
tags: ["roadmap", "RM-30"]
