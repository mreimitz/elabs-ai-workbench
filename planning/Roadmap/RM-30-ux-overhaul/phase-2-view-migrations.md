...
title: "Phase 2 \u2014 View migrations (fan-out; every WP depends on ALL of Phase 1)"
description: "Each WP migrates one feature area onto the Phase-1 foundations AND fixes that area's per-view"
tags: ["roadmap", "RM-30"]
