...
title: "12 \u2014 Runs as one product: a unified session contract for the API, CLI and the vendor assistant executors"
description: "Investigation + proposal. The owner reported two problems with runs: (1) every session feels and"
tags: ["roadmap", "RM-12"]
