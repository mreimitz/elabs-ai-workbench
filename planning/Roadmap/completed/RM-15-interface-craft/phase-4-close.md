...
title: "Phase 4 \u2014 Close \u00b7 Batch K \u00b7 4.1 solo \u2192 then 4.2 (owner)"
description: "Assert the six new rules in CI so they can't drift back, then re-run the review and prove it with"
tags: ["roadmap", "RM-15"]
