...
title: "Interface Craft \u2014 conventions (shared implementation rules)"
description: "Every WP in this plan assumes the rules below. Read this and your WP spec before writing code. The"
tags: ["roadmap", "RM-15"]
...
program index and locked decisions are in [`README.md`](./item.md); the ledger is
[`STATUS.md`](./STATUS.md).
...
findings, with reasons. **No WP proposes any of them** (details in [`README`](./item.md) /
