...
title: "Phase 2 \u2014 Consistency \u00b7 Batch I (4 parallel) \u00b7 enter after Batch H merged"
description: "One meaning per color, one recovery per truncation, one elevation per card, one exit per dead-end. Read"
tags: ["roadmap", "RM-15"]
