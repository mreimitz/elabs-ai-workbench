...
title: "WP 2.3 \u2014 Fleet footprint plots every server, carried from its last successful scan"
description: "\"fleet footprint shows only scanned MCP servers which have been scanned during the selected time"
tags: ["roadmap", "RM-11"]
