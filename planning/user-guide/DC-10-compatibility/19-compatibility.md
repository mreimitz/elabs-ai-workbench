---
type: "Guide Page"
title: "19. Model compatibility \u2014 will this server fit?"
description: "A tool surface that's comfortable for one model can overflow another. Compatibility (under"
tags: ["documentation", "DC-10"]
...
![The compatibility heatmap — every tool scored across a roster of models, with issue counts per cell.](../DC-23-product-overview/images/15-compatibility.png)
...
[test run](../DC-08-testing-console/09-testing.md) and [Review](../DC-11-observability/17-observability.md#the-review-queue) for the judgment
calls.
