---
type: "Guide Page"
title: "21. Service tokens \u2014 reaching the workbench without a browser"
description: "Everything else in this guide assumes you are sitting in front of the app. This page is about the"
tags: ["documentation", "DC-17"]
...
[MCP endpoint](../DC-16-workbench-mcp-server/20-workbench-mcp-server.md). Each of those three tools needs its permission **plus**
...
| Connect an assistant to the workbench's own [MCP endpoint](../DC-16-workbench-mcp-server/20-workbench-mcp-server.md) | **Read** |
...
[`mcpfp` command line](../DC-18-mcpfp-cli/22-mcpfp-cli.md), and the workbench's own
[MCP endpoint](../DC-16-workbench-mcp-server/20-workbench-mcp-server.md#connecting-from-another-machine) — where the token goes
...
- [Workbench agent playbook](../DC-16-workbench-mcp-server/20-workbench-mcp-server.md) — pointing an AI assistant at the app.
...
- [The `mcpfp` command line](../DC-18-mcpfp-cli/22-mcpfp-cli.md) — scans, reports and footprint gates from a script.
- [Settings](../DC-14-settings-and-features/13-settings.md) — the rest of what lives in Settings.
- [Troubleshooting & FAQ](../DC-15-operations/14-troubleshooting.md) — if a call is being refused and you are not sure
  why.
