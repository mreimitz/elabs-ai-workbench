...
type: "Guide Page"
title: "6. Run a tool"
description: "A scan tells you what a tool's definition costs. But when"
tags: ["documentation", "DC-05"]
timestamp: "2026-08-20T13:47:37Z"
status: "current"
---
# 6. Run a tool

A [scan](../DC-03-scans-and-footprint/04-scan-and-read-footprint.md) tells you what a tool's *definition* costs. But when
...
From a tool's detail panel (see [Scan and read the footprint](../DC-03-scans-and-footprint/04-scan-and-read-footprint.md)),
...
Next: [Export reports →](../DC-06-reports/07-reports.md)
