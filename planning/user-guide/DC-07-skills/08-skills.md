---
type: "Guide Page"
title: "8. Skills (overview)"
description: "Beyond analyzing MCP servers, the app includes a Skills area for working with Agent"
...
![The skill inspector: frontmatter, the L1/L2/L3 token footprint with its split, and the security surface (scripts, network references, file and byte totals).](../DC-23-product-overview/images/14-skills.png)
...
an agent loop (see [Testing](../DC-08-testing-console/09-testing.md)) — either always the latest version, or a pinned
...
![The Issues tab on a skill: an automatically filed issue with its severity, a drafted fix, the failing run listed under Occurrences, and Resolve / Fix-with-assistant actions.](../DC-23-product-overview/images/19-skill-issue-feedback.png)

From here you can **Resolve** the issue yourself, or hand it to the [Assistant](../DC-12-app-assistant/12-assistant.md)
...
Next: [Testing console →](../DC-08-testing-console/09-testing.md)
