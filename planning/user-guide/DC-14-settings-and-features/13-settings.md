...
type: "Guide Page"
title: "13. Settings"
description: "Open Settings from the top bar. It's where you manage credentials, appearance, and the"
tags: ["documentation", "DC-14"]
...
To use the [Testing console](../DC-08-testing-console/09-testing.md) (and, optionally, the
[Assistant](../DC-12-app-assistant/12-assistant.md) via an API key), you add **provider credentials** — API keys for
...
Connect the [Assistant](../DC-12-app-assistant/12-assistant.md) to Claude, using either your **Claude subscription**
...
See [Troubleshooting](../DC-15-operations/14-troubleshooting.md) for more.

---

Next: [Troubleshooting & FAQ →](../DC-15-operations/14-troubleshooting.md)
