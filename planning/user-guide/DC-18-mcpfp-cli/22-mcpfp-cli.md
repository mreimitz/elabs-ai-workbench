---
type: "Guide Page"
title: "22. The mcpfp command line \u2014 scans, reports and build gates from a terminal"
description: "Everything the workbench measures is reachable from a browser. This page is about doing the same"
tags: ["documentation", "DC-18"]
...
> Companion pages: [Service tokens](../DC-17-service-tokens/21-service-tokens.md) for the credential a remote caller
> presents, and the [Workbench agent playbook](../DC-16-workbench-mcp-server/20-workbench-mcp-server.md) for letting an AI
...
for your browser — see [Service tokens](../DC-17-service-tokens/21-service-tokens.md). You need a token when the workbench
...
`mcpfp.assert.suite.example.json`:
...
- **`markdown`** is the **pull-request comment**: a pass/fail heading, what was asserted, the
  ...
  **Everything (demo) (JS8YDxdw9pvo3B1hS-keH)** · scan `r-3ZMS8fNiNfoBu6O0Qfs` · captured 2026-08-19T20:25:56.402Z
  ...
  [GitHub Actions with `mcpfp`](../DC-19-ci-github-actions/23-ci-github-actions.md) for two workflows that do exactly that.
