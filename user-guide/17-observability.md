...
[Getting started](./02-getting-started.md#the-dashboard)):
...
![Watch rules — standing alerts that fire when a run matches conditions you set.](./images/22-watch-rules.png)

## The Review queue

Automatic grading (see [Testing console](./09-testing.md) and the run **Report** tab) happens on
...
![The Review queue — runs waiting to be judged against a rubric.](./images/21-review.png)
...
Next: [Suites & benchmarks →](./18-suites-and-benchmarks.md)
