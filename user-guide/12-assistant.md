...
> [16. Assistant →](./16-assistant-hub.md). This dock is the lighter-weight in-app helper; the two
...
example, editing a [skill](./08-skills.md) produces a **new immutable version** rather than
overwriting what was there.

## Signing it in

The App assistant runs on Claude, and you connect it in [Settings](./13-settings.md) using **your
