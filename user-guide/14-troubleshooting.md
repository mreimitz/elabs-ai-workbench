...
Make sure you're using the [token profile](./01-key-concepts.md) that matches your target model.
...
[Settings](./13-settings.md) first.

## Assistant

**The Assistant is asking me to sign in.**
Connect it in [Settings](./13-settings.md) using your Claude subscription or an Anthropic API
