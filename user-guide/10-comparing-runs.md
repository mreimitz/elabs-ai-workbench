...
![The run-comparison Summary: a verdict sentence, an environment matrix with per-metric deltas, and context-window curves.](./images/12-run-compare.png)
...
![The Flow view comparing two runs' reasoning and their final answers side by side in the Result panel.](./images/20-qa-run-compare-flow.png)
