...
![A suite run report — pass rate, consistency, cost, and per-test grades across the matrix.](./images/23-suite-run.png)
...
Next: [Model compatibility →](./19-compatibility.md)
