...
The [`mcpfp` command line](./22-mcpfp-cli.md) turns a measurement into a verdict with an exit code.
...
| File | Topology |
| --- | --- |
| [`examples/github-actions/mcpfp-footprint-gate.yml`](../examples/github-actions/mcpfp-footprint-gate.yml) | **A** — a throwaway workbench started on the runner |
| [`examples/github-actions/mcpfp-remote-gate.yml`](../examples/github-actions/mcpfp-remote-gate.yml) | **B** — a persistent workbench your team already runs |
...
> Companion pages: [The `mcpfp` command line](./22-mcpfp-cli.md) for the commands themselves, and
> [Service tokens](./21-service-tokens.md) for the credential topology B needs.
...
[Service tokens](./21-service-tokens.md)). Tick only what the job needs:
...
[The `mcpfp` command line](./22-mcpfp-cli.md#the-rules).
