...
> record**; the executable implementation plan lives at [`../testing-ia/`](../testing-ia/)
> (ledger: [`STATUS.md`](../testing-ia/STATUS.md), driven by `/next-wp testing-ia` with parallel
...
- **Execution directive:** implement via `/next-wp testing-ia` — the plan is sliced so up to 4
  ...
  batch map in [`../testing-ia/README.md`](../testing-ia/README.md).
...
2. ~~Turn this into a full implementation plan~~ — **done**: [`roadmap/testing-ia/`](../testing-ia/)
   (README = plan + parallel batch map, phase files = WP specs with Files/Acceptance,
   [`STATUS.md`](../testing-ia/STATUS.md) = authoritative ledger).
