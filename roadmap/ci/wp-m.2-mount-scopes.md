...
the [testing conventions](../testing/conventions.md) + the repo rules in `.claude/rules/`.
...
5. **Docs** — the mount's scope requirements in
   [`user-guide/20-workbench-mcp-server.md`](../../user-guide/20-workbench-mcp-server.md) and
   [`user-guide/21-service-tokens.md`](../../user-guide/21-service-tokens.md), and in the served
