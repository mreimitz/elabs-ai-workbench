...
Successor plan to [`../skillflow/`](../skillflow/) (all 13 WPs shipped). Skill IDE turns the
...
5. **The IDE teaches.** Every element — node/edge kinds, frontmatter keys, annotations,
   ...
   its [`docs/skill-authoring.md`](../../docs/skill-authoring.md) anchor, surfaced in the node
