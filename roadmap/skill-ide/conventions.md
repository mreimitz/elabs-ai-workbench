...
The [SkillFlow conventions](../skillflow/conventions.md) apply **verbatim** to every Skill IDE
...
- **Rule ↔ guide contract (owner-added 2026-07-04):** the canonical skill best-practices doc is
  [`docs/skill-authoring.md`](../../docs/skill-authoring.md) — quality/validation ruleIds share
