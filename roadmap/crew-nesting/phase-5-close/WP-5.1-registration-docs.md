...
2. **CLAUDE.md SoT list:** Add `[`roadmap/crew-nesting/STATUS.md`](./roadmap/crew-nesting/STATUS.md)` to the bullet list on line 24–43 (the "single source of truth for in-flight status" block), maintaining alphabetical order within the list.
