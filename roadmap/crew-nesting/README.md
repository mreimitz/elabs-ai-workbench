# Crew nesting — hierarchical, runtime-recursive crews · **PRIORITY: HIGH**
...
[`../testing/conventions.md`](../testing/conventions.md)). Grounding evidence (the seven subsystem
...
| | |
|---|---|
| **Original (D-AH9, [`assistant-hub/README.md:67`](../assistant-hub/README.md))** | "Decomposition depth is **1** (planner only) in v1; recursion is a flagged future option." Enforced *structurally*: `proposePlan` requires `session.kind === 'chat'` ([`orchestrator.ts:330`](../../apps/api/src/hub/missions/orchestrator.ts)); the `mission.propose_plan` builtin is withheld from agent sessions ([`tools/builtins/index.ts`](../../apps/api/src/hub/tools/builtins/index.ts)); `HubMissionPlan.agents` is a **flat** array. |
...
improvise (house rule; see [`assistant-hub/README.md`](../assistant-hub/README.md)).
...
7. **brand-ui only + two themes:** all UI from `@brand/*`, correct in `qlik-bright` **and** `qlik-dark`.
