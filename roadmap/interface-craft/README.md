...
Source of truth: [`docs/INTERFACE-REVIEW-2026-07-25.md`](../../docs/INTERFACE-REVIEW-2026-07-25.md) —
...
- **Phase 0 amendments, restated for the merged world:**
  ...
  - **0.c (D-TB1 amendment — section-titling cards need a semantic heading)** is recorded, as
    ...
    [`roadmap/ux-overhaul/toolbar-standard-2026-07-11.md`](../ux-overhaul/toolbar-standard-2026-07-11.md)
    and cross-linked from [`roadmap/toolbar-reach/README.md`](../toolbar-reach/README.md). It is
...
Reaffirm **D-UX9** ([`roadmap/ux-overhaul/STATUS.md:143`](../ux-overhaul/STATUS.md)) and move it into a
